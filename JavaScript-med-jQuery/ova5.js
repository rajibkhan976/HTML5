...
//18
var userAction, lifeOne, lifeTwo;
var dragon = ['block', 'not block']; var dragonLife = 10, userLife = 10;

function checkUser () {
userAction = window.prompt("You have encountered a dragon and we need to know what to do. Writing  1 will attack the dragon, writing 2 will hide");
  if (userAction == 1) {
...
function dragonGame (lifeOne, lifeTwo) {
  if (lifeOne == 0 || lifeTwo == 0) {
    ...
    for (lifecount = 0; lifecount < lifeOne || lifecount < lifeTwo; ) {
      checkUser ();
    }
  }
}
dragonGame (lifeOne, lifeTwo);
